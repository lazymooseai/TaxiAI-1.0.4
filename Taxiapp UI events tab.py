...
🏟️ Urheilu     — jääkiekko, jalkapallo, yleisurheilu
🏛️ Politiikka  — eduskunta, valtuusto, mielenosoitukset
...
from taxiapp.base_agent import AgentResult
...
return {
“ending”:   (“ending-soon”,   COLOR_RED,  “⏱️ Loppuu pian”),
...
# Kategoria-emoji
cat_icon = {"kulttuuri": "🎵", "urheilu": "🏟️", "politiikka": "🏛️"}.get(cat, "📅")
...
with c3:
    st.metric("⏱️ Loppuu pian", ending)
with c4:
...
tab1, tab2, tab3, tab4 = st.tabs([
    ...
    f"🏟️ Urheilu ({urheilu_n})",
    f"🏛️ Politiikka ({politiikka_n})",
    f"📅 Kaikki ({kaikki_n})",
])
